...
public class CheckoutPage extends Utility {
    ...
    public void enterEmail(){
        sendTextToElement(email,"rajuT123S@gmail.com");
    }
    public void enterTelephone(){
        sendTextToElement(telephone,"0756837890");
    }
    public void enterAddress() {
        sendTextToElement(address, "Malven Street");
    }
    public void enterCity(){
        sendTextToElement(city,"London");
    }
    public void enterPostcode(){
        sendTextToElement(postcode,"HA4 4SU");
    }
    public void enterCountry(){
        sendTextToElement(country,"United Kingdom");
    }
    public void enterState(){
        sendTextToElement(state,"Milton Keynes");
    }
